# True value
true_value <- c(pnorm(0),pnorm(0.67),pnorm(0.84),
                pnorm(1.28),pnorm(1.65),pnorm(2.32),
                pnorm(2.58),pnorm(3.09),pnorm(3.72))
round(true_value, 4)
...
#过程中需要用到的程序包：“ggplot2”“lattice”“plyr”“Rmisc”
library(ggplot2)
library(lattice)
library(plyr)
library(Rmisc)
